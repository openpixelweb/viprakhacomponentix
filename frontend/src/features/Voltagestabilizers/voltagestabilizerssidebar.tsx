...
const applications: ServiceLinkItem[] = [
    ...
    { id: 3, label: 'CNC Machines & Production Equipment' },
    { id: 4, label: 'Process Industries' },
    { id: 5, label: 'Power Distribution Networks' },
    { id: 6, label: 'Data Centers' },
    { id: 7, label: 'Commercial & Industrial Facilities' },
