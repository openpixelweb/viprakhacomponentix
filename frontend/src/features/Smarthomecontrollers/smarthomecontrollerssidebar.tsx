...
const applications: ServiceLinkItem[] = [
    { id: 1, label: 'Smart Building Infrastructure' },
    { id: 2, label: 'Facility Management Systems' },
    { id: 3, label: 'Energy Management Applications' },
    { id: 4, label: 'Intelligent Control Networks' },
    { id: 5, label: 'Connected Device Ecosystems' },
    { id: 6, label: 'Building Automation Systems' },
     { id: 7, label: 'Integrated Monitoring Platforms' },
