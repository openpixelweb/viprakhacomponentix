...
const applications: ServiceLinkItem[] = [
    { id: 1, label: 'Manufacturing Facilities' },
    { id: 2, label: 'Industrial Automation Systems' },
    { id: 3, label: 'Process Industries' },
    { id: 4, label: 'Power Distribution Networks' },
    { id: 5, label: 'Commercial & Industrial Infrastructure' },
    { id: 6, label: 'Data Centers' },
     { id: 7, label: 'Renewable Energy Installations' },
