...
const applications: ServiceLinkItem[] = [
    { id: 1, label: 'Smart Homes' },
    { id: 2, label: 'Residential Apartments' },
    { id: 3, label: 'Commercial Buildings' },
    { id: 4, label: 'Office Spaces' },
    { id: 5, label: 'Hospitality Facilities' },
    { id: 6, label: 'Home Automation Projects' },
    { id: 7, label: 'Intelligent Building Management Systems' },
