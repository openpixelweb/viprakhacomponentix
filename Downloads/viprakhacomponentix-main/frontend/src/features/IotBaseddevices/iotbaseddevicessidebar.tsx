...
const applications: ServiceLinkItem[] = [
    ...
    { id: 2, label: 'Smart Home Solutions' },
    { id: 3, label: 'Energy Monitoring Applications' },
    { id: 4, label: 'Manufacturing Facilities' },
    { id: 5, label: 'Building Management Systems' },
    { id: 6, label: 'Asset Tracking & Monitoring' },
     { id: 7, label: 'Connected Consumer Devices' },
