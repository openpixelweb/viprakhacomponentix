...
const applications: ServiceLinkItem[] = [
    { id: 1, label: 'Industrial Facilities' },
    { id: 2, label: 'Commercial Buildings' },
    { id: 3, label: 'Renewable Energy Projects' },
    { id: 4, label: 'Solar Power Systems' },
    { id: 5, label: 'Smart Grids' },
    { id: 6, label: 'Data Centers' },
    { id: 7, label: 'Residential Energy Storage Solutions' },
